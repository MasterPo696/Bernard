...
from data.nets.crypto.words import extended_word_list, value_list, metrics_list, EPOCHS, VOCAB_SIZE
from data.nets.utils.drawer import draw_results
from data.nets.utils.compiler import CryptoModelTrainer
DATA_PATH = "/Users/masterpo/Desktop/Bernard/data/weigths/crypto/"
...
def crypto_net():
    ...
    trainer.load_weights_into_new_model()
